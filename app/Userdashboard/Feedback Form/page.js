...
const Feedback = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        'https://learnospherebackend.singhbrothers.ltd/api/route/studentfeedbackform',
        formData,
        {
          headers: {
      ...
      >
        ...
        <span className='flex flex-col gap-1'>
          <label
            ...
            className='block text-gray-700 text-[.9em] font-bold'
          >
            Class<b className='text-orange-600'>*</b>
          </label>
          <input
            id='classes'
            name='classes'
          ...
          />
          {errors.classes && (
            <p className='text-red-500 text-sm mb-4'>{errors.classes}</p>
          )}
        </span>
